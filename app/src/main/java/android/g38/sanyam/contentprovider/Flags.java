...
public class Flags extends ContentProvider {

    static final public String PROVIDER_NAME = "android.g38.sanyam.contentprovider.TASKS";
    static final public String URL = "content://" + PROVIDER_NAME + "/flags";
    ...
    static{
        ...
        uriMatcher.addURI(PROVIDER_NAME, "flags", STUDENTS);
        uriMatcher.addURI(PROVIDER_NAME, "flags/#", STUDENT_ID);
    }
